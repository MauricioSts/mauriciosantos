...
function TrueFocus({
  ...
  return (
    <div className="relative flex gap-2 md:gap-3 justify-center items-center flex-wrap" ref={containerRef}>
      {words.map((word, index) => {
        ...
        return (
          <span
            ...
            className={`relative font-semibold cursor-pointer ${wordClass}`}
            style={{
